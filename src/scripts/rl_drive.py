...
class data_collector:
  ...
  def callback(self,data):
    ...
    if spawn_at_start:
      self.spawn_position(1.25, 0.4, 0.5, 0,0,1,1)
      # self.initial_turn()
      spawn_at_start = False
    ...
    if (depressed == 1):
       print('saving')
       depressed = 0
       np.save('/home/fizzer/ros_ws/src/controller_pkg/data/sand_data_1/data_vels'+str(self.flag)+
               '.npy', self.vel_cmds)
       np.savez_compressed('/home/fizzer/ros_ws/src/controller_pkg/data/sand_data_1/img_gray_comp'
                           +str(self.flag)+'.npz', *self.drive_imgs_gray)
       np.savez_compressed('/home/fizzer/ros_ws/src/controller_pkg/data/sand_data_1/img_rgb_comp'
